# Copilot instructions for this workshop site
...
- Explain a proposed change in plain language before making a large edit.
...
3. use the keyboard to move through links and the menu;
4. inspect the changed lines; and
5. commit only after the page still works.
